...
<header>
	...
	<div class="topnav">
	  ...
	  <a href="womenK.php" >Kurtis</a>
	  <a href="womenT.php" >Top</a>
	  <a href="#" class="current">Jeans</a>
	  <a href="buyeraboutw.html">About Us</a>
	 </div>
			...
			<div id="id01" class="modal">
				...
				$sql = "SELECT prod_id,name,type,size,cost,img FROM products WHERE gender='Female' AND type='Jeans'";
